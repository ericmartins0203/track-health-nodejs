...
export class firstCommit1650488524288 implements MigrationInterface {
    name = 'firstCommit1650488524288'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_vaccine" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" character varying, "dose" integer, "vaccineId" uuid, "userId" uuid, CONSTRAINT "PK_29d686068f737824f9ce09da0ae" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "profileImage" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "url" character varying NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "REL_5f1aea3730b5a2a4600bd7ff66" UNIQUE ("userId"), CONSTRAINT "PK_9d401e89e415fc9ae4313dcf7ff" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_vaccine" ADD CONSTRAINT "FK_c17a8f2fdff7256c4165442201a" FOREIGN KEY ("vaccineId") REFERENCES "vaccine"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_vaccine" DROP CONSTRAINT "FK_c17a8f2fdff7256c4165442201a"`);
